...
export type InstanceSetting_StorageSetting_S3Config = Message<"memos.api.v1.InstanceSetting.StorageSetting.S3Config"> & {
   ...
   *
   * @generated from field: memos.api.v1.InstanceSetting.StorageSetting.S3Config.S3UrlMode url_mode = 8;
   */
  urlMode: InstanceSetting_StorageSetting_S3Config_S3UrlMode;

  /**
   * url_prefix is the public base URL used when url_mode == CUSTOM_DOMAIN,
   * e.g. https://cdn.example.com/memos.
   *
   * @generated from field: string url_prefix = 9;
   */
  urlPrefix: string;
};
 ...
 *
 * @generated from enum memos.api.v1.InstanceSetting.StorageSetting.S3Config.S3UrlMode
 */
export enum InstanceSetting_StorageSetting_S3Config_S3UrlMode {
  /**
   * @generated from enum value: S3_URL_MODE_UNSPECIFIED = 0;
   */
   ...
   *
   * @generated from enum value: PRESIGNED = 1;
   */
  PRESIGNED = 1,
   ...
   *
   * @generated from enum value: CUSTOM_DOMAIN = 2;
   */
  CUSTOM_DOMAIN = 2,
}

/**
 * Describes the enum memos.api.v1.InstanceSetting.StorageSetting.S3Config.S3UrlMode.
 */
export const InstanceSetting_StorageSetting_S3Config_S3UrlModeSchema: GenEnum<InstanceSetting_StorageSetting_S3Config_S3UrlMode> = /*@__PURE__*/
  enumDesc(file_api_v1_instance_service, 2, 1, 0, 0);
