...
export type UserSetting_GeneralSetting = Message<"memos.api.v1.UserSetting.GeneralSetting"> & {
  ...
  /**
   * When enabled, new memos are forced to private and changing visibility to public requires confirmation.
   *
   * @generated from field: bool privacy_lock = 5;
   */
  privacyLock: boolean;
};
