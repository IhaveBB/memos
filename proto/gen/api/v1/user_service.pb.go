...
type UserSetting_GeneralSetting struct {
	...
	PrivacyLock   bool `protobuf:"varint,5,opt,name=privacy_lock,json=privacyLock,proto3" json:"privacy_lock,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UserSetting_GeneralSetting) GetPrivacyLock() bool {
	if x != nil {
		return x.PrivacyLock
	}
	return false
}
...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x05stats\x18\x01 \x03(\v2\x17.memos.api.v1.UserStatsR\x05stats\"\xe8\a\n" +
	...
	"\ftags_setting\x18\x06 \x01(\v2%.memos.api.v1.UserSetting.TagsSettingH\x00R\vtagsSetting\x1a\x9e\x01\n" +
	...
	"\fprivacy_lock\x18\x05 \x01(\bB\x03\xe0A\x01R\vprivacyLock\x1ay\n" +
	"\vTagMetadata\x12B\n" +
